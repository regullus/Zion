...
namespace Sistema.Controllers
{
   ...
   public class AssociacoesController : Controller
   {
      #region Variaveis
      ...
      public ActionResult Index(string SortOrder, string CurrentProcuraNome, string ProcuraNome, int? NumeroPaginas, int? Page)
      {
         ...
         objFuncoes.Persistencia(ref SortOrder, ref CurrentProcuraNome, ref ProcuraNome, ref NumeroPaginas, ref Page, "Associacao");
         objFuncoes = null;
         ...
         IQueryable<Associacao> lista = null;
         lista = db.Associacao;
      ...
      public ActionResult Details(int? id)
      {
         ...
         Associacao Associacao = db.Associacao.Find(id);
         if (Associacao == null)
         {
            return HttpNotFound();
         }
      ...
      public ActionResult DeleteConfirmed(int id)
      {
         ...
         Associacao Associacao = db.Associacao.Find(id);
         db.Associacao.Remove(Associacao);
         db.SaveChanges();
         return RedirectToAction("Index");
      }
