...
-- Author.....: 
-- Create date: 
-- Description: Gera registro de Afiliados ate o nivel informado e retorna os dados
-- =============================================================================================
...
Begin
   ...
   if(@NivelFilho = 1) 
   Begin
     If Exists (Select 'x' From Usuario.Superiores (nolock) Where ID = @id and nivel = @MaxNivel)
      Begin
         Set @Continua = 0
      End
      Else
     ...
     Begin
        ...
        --  ******* Inicio Cursor *******
         ...
         If (Select @@CURSOR_ROWS) <> 0
            Begin
               Fetch Next From curRegistro Into @IDSuperior, @Nivel -- Proxima linha do cursor  
