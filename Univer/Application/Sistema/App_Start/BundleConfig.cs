namespace Sistema
{
    ...
    public static class BundleConfig
    {
        ...
        private static void AddCss(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/css/theme/login")
            ...
            //BEGIN GLOBAL MANDATORY STYLES
            bundles.Add(new StyleBundle("~/css/theme/mandatory")
            ...
            //BEGIN THEME STYLES
            bundles.Add(new StyleBundle("~/css/theme/style")
               .Include("~/Content/global/css/components.min.css")
               .Include("~/Content/global/css/plugins.min.css")
            ...
            //BEGIN THEME TYPE
            bundles.Add(new StyleBundle("~/css/theme/type")
               .Include(strPath)
               );
            //END THEME TYPE
            ...
            //Pagina de Home
            bundles.Add(new StyleBundle("~/Content/home", ContentDeliveryNetwork.MaxCdn.FontAwesomeUrl)
               //.Include("~/Content/global/plugins/jplot/jquery.jqplot.css")
               .Include("~/Content/global/plugins/owl-carousel2/owl.carousel.css")
               .Include("~/Content/global/plugins/owl-carousel2/owl.theme.default.css")
               );

            //Pagina MeusDados
            bundles.Add(new StyleBundle("~/Content/meusdados", ContentDeliveryNetwork.MaxCdn.FontAwesomeUrl)
               .Include("~/Content/global/plugins/bootstrap-fileinput/bootstrap-fileinput.css")
               );

            //Pagina Cadastro
            bundles.Add(new StyleBundle("~/Content/cadastro", ContentDeliveryNetwork.MaxCdn.FontAwesomeUrl)
               .Include("~/Content/global/plugins/bootstrap-fileinput/bootstrap-fileinput.css")
            ...
            bundles.Add(new StyleBundle("~/Content/detalhes", ContentDeliveryNetwork.MaxCdn.FontAwesomeUrl)
               .Include("~/Content/global/plugins/bootstrap-fileinput/bootstrap-fileinput.css")
               .Include("~/Content/admin/pages/css/profile.min.css")
               );

            //Agendamento
            bundles.Add(new StyleBundle("~/Content/agendamento", ContentDeliveryNetwork.MaxCdn.FontAwesomeUrl)
            ...
            //dataPiker
            bundles.Add(new StyleBundle("~/Content/dataPiker")
               .Include("~/Content/global/plugins/JQueryUICustom/jquery-ui.css")
            );

            //Crop image
            bundles.Add(new StyleBundle("~/Content/crop")
               .Include("~/Content/global/plugins/jcrop/css/jquery.Jcrop.min.css")
               );

            //Calendario
            bundles.Add(new StyleBundle("~/Content/calendario")
            ...
            //Table
            bundles.Add(new StyleBundle("~/Content/table")
              .Include("~/Content/global/plugins/select2/select2.min.css")
            ...
            //TableLeft
            bundles.Add(new StyleBundle("~/Content/tableLeft")
              .Include("~/Content/admin/css/tabLeft.css")
           );


            //tableSort
            bundles.Add(new StyleBundle("~/Content/tableSort")
               .Include("~/Content/global/plugins/tablesorter/css/jquery.tablesorter.pager.min.css")
           );

            //Rede
            bundles.Add(new StyleBundle("~/Content/rede")
            ...
            #region pagetour
            //PageTour
            bundles.Add(new StyleBundle("~/Content/pagetour")
               .Include("~/Content/ptjs/css/ptjs.min.css")
               .Include("~/Content/ptjs/themes/classic.min.css")
               );
            #endregion
        }
        ...
        private static void AddJavaScript(BundleCollection bundles)
        {
            ...
            Bundle scrThemeComum = new ScriptBundle("~/scripts/theme/comum")
            ...
            Bundle scrThemeLogin = new ScriptBundle("~/scripts/theme/login")
            ...
            //BEGIN CORE JQUERY
            Bundle scrThemeJquery = new ScriptBundle("~/scripts/theme/jquery")
               .Include("~/Content/global/plugins/jquery.min.js")
            ...
            //BEGIN CORE PLUGINS
            Bundle scrThemeCore = new ScriptBundle("~/scripts/theme/core")
               .Include("~/Content/global/plugins/jquery-migrate.min.js")
               ...
               .Include("~/Content/global/plugins/jAlert/jAlert-v4.min.js")
               .Include("~/Content/global/plugins/jAlert/jAlert-functions.min.js")
               ;
            bundles.Add(scrThemeCore);
            //END CORE PLUGINS

            //BEGIN THEME GLOBAL SCRIPTS
            Bundle scrThemeGlobal = new ScriptBundle("~/scripts/theme/themeglobal")
            ...
            Bundle scrThemeLayout = new ScriptBundle("~/scripts/theme/themelayout")
            ...
            //BEGIN CUSTOM
            Bundle failoverCoreBundle = new ScriptBundle("~/scripts/custom")
            ...
            //Pagina Cadastro
            Bundle cadastroBundle = new ScriptBundle("~/scripts/cadastro")
               .Include("~/Content/global/plugins/jquery-slimscroll/jquery.slimscroll.min.js")
               .Include("~/Content/global/plugins/jquery-validation/js/jquery.validate.min.js")
            ...
            //Pagina Detalhes Usuario
            Bundle detalhesBundle = new ScriptBundle("~/scripts/detalhes")
               .Include("~/Content/global/plugins/bootstrap-fileinput/bootstrap-fileinput.js")
            ...
            Bundle agendamentoBundle = new ScriptBundle("~/scripts/agendamento")
               .Include("~/Content/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js")
            ...
            //DataPicker
            Bundle dataPickerBundle = new ScriptBundle("~/scripts/dataPiker")
            ...
            //Crop Image
            Bundle cropBundle = new ScriptBundle("~/scripts/crop")
            ...
            //Calendario
            Bundle dataCalendario = new ScriptBundle("~/scripts/calendario")
            ...
            //FileUpload
            Bundle dataFileUpload = new ScriptBundle("~/scripts/fileupload")
            ...
            //Table
            Bundle dataTable = new ScriptBundle("~/scripts/table")
               .Include("~/Content/global/plugins/select2/select2.min.js")
            ...
            //TableSort
            Bundle dataTableSort = new ScriptBundle("~/scripts/tableSort")
            ...
            //Rede
            Bundle dataRede = new ScriptBundle("~/scripts/rede")
               .Include("~/Content/rede/jquery.layout-latest.js")
               .Include("~/Content/rede/demo/js/primitives.latest.js");
            bundles.Add(dataRede);

            //BEGIN FLOT
            Bundle scrFlot = new ScriptBundle("~/scripts/theme/flot")
            ...
            //Datatables
            Bundle dataDatatables = new ScriptBundle("~/scripts/datatables")
            ...
            //Datatables
            Bundle dataEditable = new ScriptBundle("~/scripts/editable")
                .Include("~/Content/pages/scripts/table-datatables-editable.min.js")
               ;
            bundles.Add(dataEditable);

            //validationPlugin
            Bundle validationPlugin = new ScriptBundle("~/scripts/validationPlugin")
               .Include("~/Content/global/plugins/jquery-validation/js/jquery.validate.min.js")
               .Include("~/Content/global/plugins/jquery-validation/js/additional-methods.min.js")
              ;
            ...
            //validationScript
            Bundle validationScript = new ScriptBundle("~/scripts/validationScript")
               .Include("~/Content/pages/scripts/form-validation-md.min.js")
              ;
            bundles.Add(validationScript);

            //sweetalert
            Bundle sweetAlertBundle = new ScriptBundle("~/scripts/sweetAlert")
            ...
            #region pagetour
            //PageTour
            Bundle pagetourBundle = new ScriptBundle("~/scripts/pagetour")
               //.Include("~/Content/ptjs/vendors/jquery-3.2.1.min.js")
               //.Include("~/Content/ptjs/vendors/jquery-ui-1-12-1.min.js")
               .Include("~/Content/ptjs/js/ptjs.min.js")
            ;
            bundles.Add(pagetourBundle);
            #endregion
