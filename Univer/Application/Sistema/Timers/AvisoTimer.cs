...
namespace Sistema.Timers
{
    public class AvisoTimer
    {
        ...
        {
            //ToDo refazer mutou tudo na tabela
            ...
            //var avisos = context.Database.SqlQuery<Aviso>("SELECT UsuarioID, IdiomaID, Login, Nome, Email, TipoID FROM Usuario.Aviso (nolock) GROUP BY UsuarioID, IdiomaID, Login, Nome, Email, TipoID");
            ...
            //    emailService.Send(de, "suporte@XXXXXX.com.br", "Contas Negativas", administrador.ToString(), false);
            //}
