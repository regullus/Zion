use UniverDev
go
If Exists (Select 'Sp' From sysobjects Where id = object_id('spC_TabuleiroPagos'))
   Drop Procedure spC_TabuleiroPagos
go

Create  Proc [dbo].[spC_TabuleiroPagos]
...
go
Grant Exec on spC_TabuleiroPagos To public
go

Exec spC_TabuleiroPagos 
