                ...
                Begin
                    ...
                    Begin
                        ...
                        Begin
                            ...
                            Where
                                UsuarioID in 
								(
									@CoordinatorDir,@IndicatorDirSup,@IndicatorDirInf,@DonatorDirSup1,@DonatorDirSup2,@DonatorDirInf1,@DonatorDirInf2,
									@CoordinatorEsq,@IndicatorEsqSup,@IndicatorEsqInf,@DonatorEsqSup1,@DonatorEsqSup2,@DonatorEsqInf1,@DonatorEsqInf2
								) and
                                BoardID = @BoardID and
                            ...
                            Begin
                                ...
                                Begin
                                    ...
                                    Where
				                     ...
				                     Set @log = @log + '| 35.1 Insert into Rede.TabuleiroUsuario UsuarioID=' + TRIM(STR(@UsuarioID)) +' TabuleiroID=' + TRIM(STR(@ID)) + ' BoardID=' + TRIM(STR(@BoardID))
                                    ...
                                    Set @log = @log + '| 36.1 insert Into Rede.TabuleiroNivel'
									if exists (
										Select 
											'OK'
										From
									...
									Begin
										...
										Set
											StatusID = 3,
											Observacao = Observacao + ' UsuarioID ' + TRIM(STR(@UsuarioID)) + ' TabuleiroID=' + TRIM(STR(@ID)) + ' BoardID=' + TRIM(STR(@BoardID))
										Where
											UsuarioID = UsuarioID And
											BoardID = @BoardId and
											StatusID = 2
									...
									Set @log = @log + '| 36.2 insert Into Rede.TabuleiroNivel'
                                    Insert Into Rede.TabuleiroNivel
                                    (
                                        UsuarioID,
                                        BoardID,
                    ...
                    Begin
                        ...
                        Begin
                            ...
                            --Verifica se existe o convite já
							if not Exists ( 
								Select 
								'OK' 
								From 
                    ...
                    Begin
                        ...
                        Begin
                            ...
                            Begin
								...
								Set @log = @log + '| 43.1.1 Remove convite: UsuarioID=' + TRIM(STR(@UsuarioID)) + ' TabuleiroID=' + TRIM(STR(@ID)) + ' BoardID=' + TRIM(STR(@BoardID))

                                Delete
                                    Rede.TabuleiroNivel
                                Where
                                    UsuarioID = @UsuarioID And
									Observacao in ('Convite (1)','Convite (2)','Convite (3)','Convite (4)') And
                                    BoardID = @BoardID And
                                    StatusID = 1 --Aguardando ser incluido

								Set @log = @log + '| 43.1.2 Chamada é convite: BoardID=' + TRIM(STR(@BoardID))
