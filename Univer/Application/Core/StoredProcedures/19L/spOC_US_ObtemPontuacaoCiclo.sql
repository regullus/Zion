use [19L]
go
If Exists (Select 'Sp' From sysobjects Where id = object_id('spOC_US_ObtemPontuacaoCiclo'))
   Drop Procedure spOC_US_ObtemPontuacaoCiclo
go
...
go
Grant Exec on spOC_US_ObtemPontuacaoCiclo To public
go
