...
namespace Sistema.Controllers
{
   ...
   public class ConfiguracaoTiposController : Controller
   {
      #region Variaveis
      ...
      public ActionResult Index(string SortOrder, string CurrentProcuraNome, string ProcuraNome, string CurrentProcuraEndereco, string ProcuraEndereco, int? NumeroPaginas, int? Page)
      {
         ...
         objFuncoes.Persistencia(ref SortOrder, ref CurrentProcuraNome, ref ProcuraNome, ref CurrentProcuraEndereco, ref ProcuraEndereco, ref NumeroPaginas, ref Page, "Filiais");
         objFuncoes = null;
         ...
         IQueryable<ConfiguracaoTipo> lista = null;
         lista = db.ConfiguracaoTipo;
      ...
      // GET: ConfiguracaoTipos/Details/5
      public ActionResult Details(int? id)
      {
         ...
         ConfiguracaoTipo configuracaoTipo = db.ConfiguracaoTipo.Find(id);
         if (configuracaoTipo == null)
         {
            return HttpNotFound();
         }
         return View(configuracaoTipo);
      }

      // GET: ConfiguracaoTipos/Create
      ...
      // POST: ConfiguracaoTipos/Create
      // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
      
      [HttpPost]
      [ValidateAntiForgeryToken]
      public ActionResult Create([Bind(Include = "ID,Nome")] ConfiguracaoTipo configuracaoTipo)
      {
         Localizacao();
         ...
         if (string.IsNullOrEmpty(configuracaoTipo.Nome))
         {
         ...
         if (msg.Count > 1)
         {
             ...
             Mensagem(traducaoHelper["CONFIGURACAO_TIPOS"], erro, "err");
         }
         else
         {
            db.ConfiguracaoTipo.Add(configuracaoTipo);
            db.SaveChanges();
      ...
      // POST: ConfiguracaoTipos/Edit/5
      // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
      
      [HttpPost]
      [ValidateAntiForgeryToken]
      public ActionResult Edit([Bind(Include = "ID,Nome")] ConfiguracaoTipo configuracaoTipo)
      {
         Localizacao();
         ...
         {
            db.Entry(configuracaoTipo).State = EntityState.Modified;
            db.SaveChanges();
            return RedirectToAction("Index");
         }
      ...
      // GET: ConfiguracaoTipos/Delete/5
      ...
      // POST: ConfiguracaoTipos/Delete/5
      ...
      public ActionResult DeleteConfirmed(int id)
      {
         ...
         ConfiguracaoTipo configuracaoTipo = db.ConfiguracaoTipo.Find(id);
         db.ConfiguracaoTipo.Remove(configuracaoTipo);
         db.SaveChanges();
         return RedirectToAction("Index");
      }
