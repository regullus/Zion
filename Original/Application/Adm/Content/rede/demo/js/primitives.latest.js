/**
 * @preserve Basic Primitives orgDiagram v2.0.5
...
primitives.orgdiagram.BaseController.prototype._setConnectorsOffset = function (treeItemsGroups, offsetPropertyName) {
    ...
    for (index2 = 0, len2 = treeItemsGroups.length; index2 < len2; index2 += 1) {
        ...
        startPoint = new primitives.orgdiagram.Positisboomset(treeItemsGroup.startIndex, maxOffset + 1 /* it is later redefined */);
        endPoint = new primitives.orgdiagram.Positisboomset(treeItemsGroup.endIndex, prevOffset);
...
primitives.orgdiagram.Positisboomset = function (position, offset) {
