...
namespace Sistema.Controllers
{
    ...
    public class ArquivoSecaoController : Controller
    {
        #region Core

        public ArquivoSecaoController()
        {
            Localizacao();
        }
        ...
        public ActionResult Index(string SortOrder, string CurrentProcuraNome, string ProcuraNome, int? NumeroPaginas, int? Page)
        {
            ...
            objFuncoes.Persistencia(ref SortOrder, ref CurrentProcuraNome, ref ProcuraNome,
                                    ref NumeroPaginas, ref Page, "ArquivoSecao");
            ...
            IQueryable<ArquivoSecao> lista = null;

            lista = db.ArquivoSecao;
        ...
        public ActionResult Details(int? id)
        {
            ...
            ArquivoSecao ArquivoSecao = db.ArquivoSecao.Find(id);
            if (ArquivoSecao == null)
            {
                return HttpNotFound();
            }
            return View(ArquivoSecao);
        }

        // GET: ArquivoSecao/Create
        ...
        // POST: ArquivoSecao/Create
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "ID,Nome,Caminho,Atualizacao")] ArquivoSecao arquivoSecao)
        {
            Localizacao();

            arquivoSecao.Atualizacao = Core.Helpers.App.DateTimeZion;

            List<string> msg = new List<string>();
            msg.Add(traducaoHelper["CAMPO_REQUERIDO"]);

            if (string.IsNullOrEmpty(arquivoSecao.Nome))
            {
                msg.Add(traducaoHelper["NOME"]);
            }
            if (string.IsNullOrEmpty(arquivoSecao.Caminho))
            {
                msg.Add(traducaoHelper["CAMINHO"]);
            }

            if (msg.Count > 1)
            {
                string[] erro = msg.ToArray();
                Mensagem(traducaoHelper["ARQUIVO_SECAO"], erro, "err");
            }
            else
            {                
                db.ArquivoSecao.Add(arquivoSecao);
                db.SaveChanges();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nome,Caminho,Atualizacao")] ArquivoSecao arquivoSecao)
        {
            Localizacao();
            ...
            {
                arquivoSecao.Atualizacao = Core.Helpers.App.DateTimeZion;
                db.Entry(arquivoSecao).State = EntityState.Modified;
                db.SaveChanges();
                return RedirectToAction("Index");
            }
        ...
        // POST: ArquivoSecao/Delete/5
        [HttpPost, ActionName("Delete")]
        [ValidateAntiForgeryToken]
        public ActionResult DeleteConfirmed(int id)
        {
            ArquivoSecao arquivoSecao = db.ArquivoSecao.Find(id);
            db.ArquivoSecao.Remove(arquivoSecao);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
        ...
        public ActionResult Excel(string ProcuraNome)
        {
            ...
            lista = db.ArquivoSecao.Include(p => p.Arquivo);
            ...
            //*Titulo do relatorio
            string strReportHeader = traducaoHelper["ARQUIVO_SECAO"];
            ...
            objWorkSheet.Cell(4, 2).Value = traducaoHelper["CAMINHO"];
            ...
            foreach (var objFor in lista)
            {
                ...
                objWorkSheet.Cell(intLinha, 2).Value = objFor.Caminho;
